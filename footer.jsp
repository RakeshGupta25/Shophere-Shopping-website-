...
<html lang="en">
 ...
 <footer class="footery" style="background:darkorange ; margin-top: 50px;" >
 
  <div class="row   pt-2 pb-5">
    <div class="col-lg-4 col-md-6 col-sm-12 pt-5">
      
      <img src="img\logo.jpg" alt="image not found" width="200px" height="80px">
      <h1 style="margin-left: 10px; color:crimson; text-align: left; font-style: italic;" >ShopHere!</h1>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12 " style="margin-top: 30px;">
      ...
      <a href="do.foodoperation?action=showfoodlist" >Menu</a><br>
      <a href="#" >Add Food</a><br>
      <a href="#" >All Orders</a><br>
    ...
    <div class="col-lg-4  pt-5" style="color: white;">
     ...
     <h5>Email id: <br><u> customerservice@foodstore.com</u></h5>
